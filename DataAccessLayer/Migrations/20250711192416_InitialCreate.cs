        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    screenShotImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    screenShotImageUrl1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    screenShotImageUrl2 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageStatu = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
